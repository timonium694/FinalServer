...
public class ProfileClient {
	...
	private ProfileService service = JAXRSClientFactory.create("http://localhost:7075/Profile-server/rest", ProfileService.class, Arrays.asList(new JacksonJsonProvider()));
